Requirements are loose and mostly tied to what open\+MTPK was tested and used on. The current installation does not allow for the building of the packages language bindings, limiting use to the core c++ lib. See below on how to build the bindings from source if interested.\hypertarget{md_docs_source_Installation_autotoc_md7}{}\doxysection{Requirements}\label{md_docs_source_Installation_autotoc_md7}
...
\end{DoxyCode}
 \hypertarget{md_docs_source_Installation_autotoc_md8}{}\doxysection{Dependencies}\label{md_docs_source_Installation_autotoc_md8}
\begin{quote}
...
\end{DoxyItemize}\hypertarget{md_docs_source_Installation_autotoc_md9}{}\doxysection{Tools}\label{md_docs_source_Installation_autotoc_md9}
