...
TEST(VectorArithINTRINSICTestI64, AdditionComparison) {
    // Create input vectors
    std::vector<int32_t> vec1 = {1, 2, 3, 4, 5, 6, 7, 8};
    std::vector<int32_t> vec2 = {8, 7, 6, 5, 4, 3, 2, 1};
...
TEST(VectorArithINTRINSICTestI64, AdditionComparisonRandom) {
...
TEST(VectorArithINTRINSICTestI64, AdditionPerformanceComparison) {
...
TEST(VectorArithINTRINSICTestI64, Subtraction) {
    // Create input vectors
    std::vector<int32_t> vec1 = {1, 2, 3, 4, 5, 6, 7, 8};
    std::vector<int32_t> vec2 = {8, 7, 6, 5, 4, 3, 2, 1};
    std::vector<int32_t> result(vec1.size());
...
TEST(VectorArithINTRINSICTestI64, SubtractionComparison) {
    // Create input vectors
    std::vector<int32_t> vec1 = {1, 2, 3, 4, 5, 6, 7, 8};
    std::vector<int32_t> vec2 = {8, 7, 6, 5, 4, 3, 2, 1};
    std::vector<int32_t> result_intrin(vec1.size());
...
TEST(VectorArithINTRINSICTestI64, SubtractionComparisonRandom) {
    const size_t size = 3333;
...
TEST(VectorArithINTRINSICTestI64, SubtractionPerformanceComparison) {
    const size_t size = 3333 * 3333;
...
TEST(VectorArithINTRINSICTestI64, Multiplication) {
...
TEST(VectorArithINTRINSICTestI64, MultComparison) {
    // Create input vector and scalar
    std::vector<int32_t> vec = {1, 2, 3, 4, 5, 6, 7, 8};
    int scalar = 2;
...
TEST(VectorArithINTRINSICTestI64, MultComparisonRandom) {
    const size_t size = 3333;
...
TEST(VectorArithINTRINSICTestI64, MultPerformanceComparison) {
    const size_t size = 3333 * 3333;
    TEST_COUT << "Vector size      : " << size << std::endl;
...
TEST(VectorArithINTRINSICTestI64, DotProduct) {
    // Create input vectors
    std::vector<int32_t> vec1 = {1, 2, 3, 4, 5, 6, 7, 8};
    std::vector<int32_t> vec2 = {8, 7, 6, 5, 4, 3, 2, 1};
...
TEST(VectorArithINTRINSICTestI64, DotProductRandom) {
    const size_t size = 3333;
...
TEST(VectorArithINTRINSICTestI64, DotProductPerformanceComparison) {
    const size_t size = 3333 * 3333;
    TEST_COUT << "Vector size      : " << size << std::endl;
