...
TEST(rc4_test, hash_XOR) {
    ...
    unsigned char *computed_0 = rc.compute(key_0, text_0, hashtext_0, x_swap);
    ...
    unsigned char *computed_01 = rc.compute(key_1, text_1, hashtext_01, x_swap);
    ...
    unsigned char *computed_02 = rc.compute(key_2, text_2, hashtext_02, x_swap);
...
TEST(rc4_test, hash_TRAD) {
    ...
    unsigned char *hashtext_10 =
        (unsigned char *)malloc(sizeof(int) * strlen(text_0));
    unsigned char *computed_10 = rc.compute(key_0, text_0, hashtext_10, t_swap);
    ...
    unsigned char *hashtext_11 =
        (unsigned char *)malloc(sizeof(int) * strlen(text_1));
    unsigned char *computed_11 = rc.compute(key_1, text_1, hashtext_11, t_swap);
    ...
    unsigned char *hashtext_12 =
        (unsigned char *)malloc(sizeof(int) * strlen(text_2));
    unsigned char *computed_12 = rc.compute(key_2, text_2, hashtext_12, t_swap);
...
TEST(rc4_test, hash_BYTE) {
    ...
    unsigned char *hashtext_20 =
        (unsigned char *)malloc(sizeof(int) * strlen(text_0));
    unsigned char *computed_20 = rc.compute(key_0, text_0, hashtext_20, b_swap);
    ...
    unsigned char *hashtext_21 =
        (unsigned char *)malloc(sizeof(int) * strlen(text_1));
    unsigned char *computed_21 = rc.compute(key_1, text_1, hashtext_21, b_swap);
    ...
    unsigned char *hashtext_22 =
        (unsigned char *)malloc(sizeof(int) * strlen(text_2));
    unsigned char *computed_22 = rc.compute(key_2, text_2, hashtext_22, b_swap);
