...
class Activate {
  public:
    ...
    linear(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    sigmoid(std::vector<std::vector<double>> z, bool deriv = 0);

    std::vector<double> softmax(std::vector<double> z, bool deriv = 0);

    std::vector<std::vector<double>>
    softmax(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    cloglog(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    logit(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    swish(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    mish(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    sinc(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    RELU(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    leakyReLU(std::vector<std::vector<double>> z, double c,
              bool deriv = 0);

    double ELU(double z, double c, bool deriv = 0);

    std::vector<double> ELU(std::vector<double> z, double c,
                            bool deriv = 0);
    ...
    std::vector<double> SELU(std::vector<double> z, double lambda,
    ...
    std::vector<std::vector<double>>
    GELU(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    sign(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    sinh(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    cosh(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    tanh(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    csch(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    sech(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    coth(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    arsinh(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    arcosh(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    artanh(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    arcsch(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    arsech(std::vector<std::vector<double>> z, bool deriv = 0);
    ...
    std::vector<std::vector<double>>
    arcoth(std::vector<std::vector<double>> z, bool deriv = 0);
