...
/**
 * @brief A class containing miscellaneous utility functions
 */
class Misc {
  public:
    /**
     * @brief Calculates the factorial of the given integer or double
     *
     * @tparam T The type of the input (int or double)
     * @param n The input value for which factorial is calculated
     * @return The factorial of the input value
     * @note For negative integer inputs, the result will be 0
     */
