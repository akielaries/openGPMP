...
int main() {
    ...
    case '1':
        ...
        // Note: 48 is a ascii value for 0, "thus -49 will produce correct
        // index
    ...
    case '3':
        ...
        if (process_data >= 1 && process_data <= total_rows) {
            ...
            for (int iterator = 0; iterator < process_data; iterator++) {
                ...
                // Setting current key hash pair into hash table
                hash_table_set(case_three_hash_table, current_key,
                               current_hash);

                // Checking current table length
                current_table_length =
                    hash_table_length(case_three_hash_table);
                printf("\t%s:Table length: %d\n", __func__,
                       current_table_length);
            }
            ...
            printf("Makse sure to enter numbers between %d and %d. ", 1,
                   total_rows);
