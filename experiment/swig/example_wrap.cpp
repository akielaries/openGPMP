...
#pragma GCC diagnostic ignored                                                 \
    "-Wregister" /* For python-2.7 headers that use register */
#endif
#endif
...
#define SWIGPY_CAPSULE_ATTR_NAME                                               \
    "type_pointer_capsule_builtin" SWIG_TYPE_TABLE_NAME
#else
#define SWIGPY_CAPSULE_ATTR_NAME "type_pointer_capsule" SWIG_TYPE_TABLE_NAME
#endif
#define SWIGPY_CAPSULE_NAME                                                    \
    ("swig_runtime_data" SWIG_RUNTIME_VERSION "." SWIGPY_CAPSULE_ATTR_NAME)
...
SWIGRUNTIME PyObject *SwigPyObject_repr(SwigPyObject *v) {
    ...
    PyObject *repr =
        SWIG_Python_str_FromFormat("<Swig Object of type '%s' at %p>",
                                   (name ? name : "unknown"),
                                   (void *)v);
    if (repr && v->next) {
...
SWIGRUNTIME void SwigPyObject_dealloc(PyObject *v) {
    ...
    if (sobj->own == SWIG_POINTER_OWN) {
        ...
        if (destroy) {
            ...
            printf("swig/python detected a memory leak of type '%s', no "
                   "destructor found.\n",
                   (name ? name : "unknown"));
        }
#endif
...
SWIGRUNTIME PyObject *SwigPyObject_New(void *ptr, swig_type_info *ty, int own) {
    ...
    if (sobj) {
        ...
        if (own == SWIG_POINTER_OWN) {
             ...
             * information, so that the module information is correctly
             * destroyed after all SWIG python objects have been freed by the GC
             * (and corresponding destructors invoked) */
...
SWIGRUNTIME PyObject *SwigPyPacked_repr(SwigPyPacked *v) {
    ...
    if (SWIG_PackDataName(result, v->pack, v->size, 0, sizeof(result))) {
        return SWIG_Python_str_FromFormat("<Swig Packed at %s%s>",
                                          result,
                                          v->ty->name);
    } else {
...
SWIGRUNTIME int SWIG_Python_ConvertPtrAndOwn(PyObject *obj,
                    ...
                    if (ptr) {
                        ...
                        *ptr = SWIG_TypeCast(tc, vptr, &newmemory);
                        if (newmemory == SWIG_CAST_NEW_MEMORY) {
                            assert(own); /* badly formed typemap which will lead
                                            to a memory leak - it must set and
    ...
    if (sobj) {
        ...
        if (implicit_conv) {
            SwigPyClientData *data =
                ty ? (SwigPyClientData *)ty->clientdata : 0;
            if (data && !data->implicitconv) {
                ...
                if (klass) {
                    ...
                    if (impconv) {
                        ...
                        if (iobj) {
                            void *vptr;
                            res = SWIG_Python_ConvertPtrAndOwn((PyObject *)iobj,
                                                               &vptr,
                                                               ty,
                                                               0,
                                                               0);
        ...
        if (empty_args) {
            ...
            if (empty_kwargs) {
                inst = ((PyTypeObject *)data->newargs)
                           ->tp_new((PyTypeObject *)data->newargs,
                                    empty_args,
                                    empty_kwargs);
...
SWIGRUNTIME void SWIG_Python_SetModule(swig_module_info *swig_module) {
    ...
    if (pointer && module) {
        if (PyModule_AddObject(module, SWIGPY_CAPSULE_ATTR_NAME, pointer) ==
            0) {
            ++interpreter_counter;
...
SWIG_Python_NonDynamicSetAttr(PyObject *obj, PyObject *name, PyObject *value) {
    ...
    if (PyString_Check(name)) {
        name = PyUnicode_Decode(PyString_AsString(name),
                                PyString_Size(name),
                                NULL,
                                NULL);
        if (!name)
...
#define SWIGTYPE_p_MathOperations swig_types[0]
...
SWIGINTERN int SWIG_AsVal_unsigned_SS_long_SS_long(PyObject *obj,
...
static int *new_std_mtx_add(size_t nelements) {
    return (new int[nelements]());
}

static void delete_std_mtx_add(int *ary) {
    delete[] ary;
}

static int std_mtx_add_getitem(int *ary, size_t index) {
    return ary[index];
}
static void std_mtx_add_setitem(int *ary, size_t index, int value) {
    ary[index] = value;
}
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_delete_SwigPyIterator(PyObject *self,
                                                 PyObject *args) {
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_value(PyObject *self,
                                                PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    void *argp1 = 0;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_incr(PyObject *self, PyObject *args) {
    ...
    if (!(argc =
              SWIG_Python_UnpackTuple(args, "SwigPyIterator_incr", 0, 2, argv)))
        SWIG_fail;
    --argc;
    if (argc == 1) {
        int _v = 0;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_decr(PyObject *self, PyObject *args) {
    ...
    if (!(argc =
              SWIG_Python_UnpackTuple(args, "SwigPyIterator_decr", 0, 2, argv)))
        SWIG_fail;
    --argc;
    if (argc == 1) {
        int _v = 0;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_distance(PyObject *self,
                                                   PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    ...
    arg1 = reinterpret_cast<swig::SwigPyIterator *>(argp1);
    res2 = SWIG_ConvertPtr(swig_obj[1],
                           &argp2,
                           SWIGTYPE_p_swig__SwigPyIterator,
                           0 | 0);
    if (!SWIG_IsOK(res2)) {
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_equal(PyObject *self,
                                                PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    swig::SwigPyIterator *arg2 = 0;
    ...
    if (!SWIG_Python_UnpackTuple(args, "SwigPyIterator_equal", 2, 2, swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0],
                           &argp1,
                           SWIGTYPE_p_swig__SwigPyIterator,
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_copy(PyObject *self, PyObject *args) {
    ...
    arg1 = reinterpret_cast<swig::SwigPyIterator *>(argp1);
    result =
        (swig::SwigPyIterator *)((swig::SwigPyIterator const *)arg1)->copy();
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result),
                                   SWIGTYPE_p_swig__SwigPyIterator,
                                   SWIG_POINTER_OWN | 0);
    return resultobj;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator___next__(PyObject *self,
                                                   PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    void *argp1 = 0;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_previous(PyObject *self,
                                                   PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    void *argp1 = 0;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator_advance(PyObject *self,
                                                  PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    ptrdiff_t arg2;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator___eq__(PyObject *self,
                                                 PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    swig::SwigPyIterator *arg2 = 0;
    ...
    if (!SWIG_Python_UnpackTuple(args, "SwigPyIterator___eq__", 2, 2, swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0],
                           &argp1,
                           SWIGTYPE_p_swig__SwigPyIterator,
...
SWIGINTERN PyObject *_wrap_SwigPyIterator___ne__(PyObject *self,
                                                 PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    swig::SwigPyIterator *arg2 = 0;
    ...
    if (!SWIG_Python_UnpackTuple(args, "SwigPyIterator___ne__", 2, 2, swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0],
                           &argp1,
                           SWIGTYPE_p_swig__SwigPyIterator,
...
SWIGINTERN PyObject *_wrap_SwigPyIterator___iadd__(PyObject *self,
                                                   PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    ptrdiff_t arg2;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator___isub__(PyObject *self,
                                                   PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    ptrdiff_t arg2;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator___add__(PyObject *self,
                                                  PyObject *args) {
    PyObject *resultobj = 0;
    swig::SwigPyIterator *arg1 = (swig::SwigPyIterator *)0;
    ptrdiff_t arg2;
...
SWIGINTERN PyObject *_wrap_SwigPyIterator___sub__(PyObject *self,
    ...
    if (!(argc = SWIG_Python_UnpackTuple(args,
                                         "SwigPyIterator___sub__",
                                         0,
                                         2,
                                         argv)))
    ...
    if (argc == 2) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
            int res = SWIG_ConvertPtr(argv[1],
                                      0,
                                      SWIGTYPE_p_swig__SwigPyIterator,
...
SWIGINTERN PyObject *_wrap_new_std_mtx_add(PyObject *self, PyObject *args) {
    PyObject *resultobj = 0;
    size_t arg1;
    size_t val1;
    int ecode1 = 0;
    ...
    result = (int *)new_std_mtx_add(SWIG_STD_MOVE(arg1));
    resultobj =
        SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_int, 0 | 0);
    return resultobj;
fail:
    return NULL;
}

SWIGINTERN PyObject *_wrap_delete_std_mtx_add(PyObject *self, PyObject *args) {
    PyObject *resultobj = 0;
    int *arg1 = (int *)0;
    void *argp1 = 0;
    int res1 = 0;
...
SWIGINTERN PyObject *_wrap_std_mtx_add_getitem(PyObject *self, PyObject *args) {
    PyObject *resultobj = 0;
    int *arg1 = (int *)0;
    size_t arg2;
    void *argp1 = 0;
    ...
    if (!SWIG_Python_UnpackTuple(args, "std_mtx_add_getitem", 2, 2, swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_int, 0 | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
    ...
    arg2 = static_cast<size_t>(val2);
    result = (int)std_mtx_add_getitem(arg1, SWIG_STD_MOVE(arg2));
...
SWIGINTERN PyObject *_wrap_std_mtx_add_setitem(PyObject *self, PyObject *args) {
    PyObject *resultobj = 0;
    int *arg1 = (int *)0;
    size_t arg2;
    int arg3;
    ...
    if (!SWIG_Python_UnpackTuple(args, "std_mtx_add_setitem", 3, 3, swig_obj))
        SWIG_fail;
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_int, 0 | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
    ...
    std_mtx_add_setitem(arg1, SWIG_STD_MOVE(arg2), arg3);
    resultobj = SWIG_Py_Void();
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject *_wrap_MathOperations_add__SWIG_0(PyObject *self,
                                                      Py_ssize_t nobjs,
                                                      PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
    int arg2;
    int arg3;
    void *argp1 = 0;
    int res1 = 0;
    ...
    if ((nobjs < 3) || (nobjs > 3))
        SWIG_fail;
    res1 =
        SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_MathOperations, 0 | 0);
    if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1),
                            "in method '"
                            "MathOperations_add"
    ...
    arg1 = reinterpret_cast<MathOperations *>(argp1);
...
SWIGINTERN PyObject *_wrap_MathOperations_add__SWIG_1(PyObject *self,
                                                      Py_ssize_t nobjs,
                                                      PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
...
SWIGINTERN PyObject *_wrap_MathOperations_add(PyObject *self, PyObject *args) {
    Py_ssize_t argc;
    PyObject *argv[4] = {0};

    if (!(argc =
              SWIG_Python_UnpackTuple(args, "MathOperations_add", 0, 3, argv)))
        SWIG_fail;
    --argc;
    if (argc == 3) {
        int _v = 0;
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_MathOperations, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
            {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_add__SWIG_0(self, argc, argv);
                }
            }
        }
    }
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_add__SWIG_1(self, argc, argv);
                }
            }
        }
    }
...
SWIGINTERN PyObject *
_wrap_MathOperations_subtract__SWIG_0(PyObject *self,
                                      Py_ssize_t nobjs,
                                      PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
    ...
    arg3 = static_cast<int>(val3);
    result = (int)(arg1)->subtract(arg2, arg3);
    resultobj = SWIG_From_int(static_cast<int>(result));
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject *
_wrap_MathOperations_subtract__SWIG_1(PyObject *self,
                                      Py_ssize_t nobjs,
                                      PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
...
SWIGINTERN PyObject *_wrap_MathOperations_subtract(PyObject *self,
                                                   PyObject *args) {
    Py_ssize_t argc;
    PyObject *argv[4] = {0};
    ...
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_subtract__SWIG_0(self,
                                                                 argc,
                                                                 argv);
                }
            }
    ...
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_subtract__SWIG_1(self,
                                                                 argc,
                                                                 argv);
                }
            }
...
fail:
    SWIG_Python_RaiseOrModifyTypeError(
        ...
        "'MathOperations_subtract'.\n"
        "  Possible C/C++ prototypes are:\n"
        "    MathOperations::subtract(int,int)\n"
        "    MathOperations::subtract(double,double)\n");
    return 0;
}

SWIGINTERN PyObject *
_wrap_MathOperations_multiply__SWIG_0(PyObject *self,
                                      Py_ssize_t nobjs,
                                      PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
...
SWIGINTERN PyObject *
_wrap_MathOperations_multiply__SWIG_1(PyObject *self,
                                      Py_ssize_t nobjs,
                                      PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
...
SWIGINTERN PyObject *_wrap_MathOperations_multiply(PyObject *self,
                                                   PyObject *args) {
    Py_ssize_t argc;
    PyObject *argv[4] = {0};
    ...
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_multiply__SWIG_0(self,
                                                                 argc,
                                                                 argv);
                }
            }
    ...
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_multiply__SWIG_1(self,
                                                                 argc,
                                                                 argv);
                }
            }
...
fail:
    SWIG_Python_RaiseOrModifyTypeError(
        ...
        "'MathOperations_multiply'.\n"
        "  Possible C/C++ prototypes are:\n"
        "    MathOperations::multiply(int,int)\n"
        "    MathOperations::multiply(double,double)\n");
    return 0;
}

SWIGINTERN PyObject *_wrap_MathOperations_divide__SWIG_0(PyObject *self,
                                                         Py_ssize_t nobjs,
                                                         PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
    ...
    arg3 = static_cast<int>(val3);
    result = (int)(arg1)->divide(arg2, arg3);
    resultobj = SWIG_From_int(static_cast<int>(result));
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject *_wrap_MathOperations_divide__SWIG_1(PyObject *self,
                                                         Py_ssize_t nobjs,
                                                         PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
...
SWIGINTERN PyObject *_wrap_MathOperations_divide(PyObject *self,
                                                 PyObject *args) {
    Py_ssize_t argc;
    PyObject *argv[4] = {0};
    ...
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_divide__SWIG_0(self,
                                                               argc,
                                                               argv);
                }
            }
    ...
    if (argc == 3) {
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    return _wrap_MathOperations_divide__SWIG_1(self,
                                                               argc,
                                                               argv);
                }
            }
...
fail:
    SWIG_Python_RaiseOrModifyTypeError(
        ...
        "'MathOperations_divide'.\n"
        "  Possible C/C++ prototypes are:\n"
        "    MathOperations::divide(int,int)\n"
        "    MathOperations::divide(double,double)\n");
    return 0;
}

SWIGINTERN PyObject *
_wrap_MathOperations_std_mtx_add__SWIG_0(PyObject *self,
                                         Py_ssize_t nobjs,
                                         PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
    ...
    (arg1)->std_mtx_add(arg2, arg3, arg4, arg5, arg6);
    resultobj = SWIG_Py_Void();
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject *
_wrap_MathOperations_std_mtx_add__SWIG_1(PyObject *self,
                                         Py_ssize_t nobjs,
                                         PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
...
SWIGINTERN PyObject *
_wrap_MathOperations_std_mtx_add__SWIG_2(PyObject *self,
                                         Py_ssize_t nobjs,
                                         PyObject **swig_obj) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
...
SWIGINTERN PyObject *_wrap_MathOperations_std_mtx_add(PyObject *self,
                                                      PyObject *args) {
    Py_ssize_t argc;
    PyObject *argv[7] = {0};
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    void *vptr = 0;
                    int res =
                        SWIG_ConvertPtr(argv[3], &vptr, SWIGTYPE_p_int, 0);
                    _v = SWIG_CheckState(res);
                    if (_v) {
                        {
                        ...
                        if (_v) {
                            ...
                            if (_v) {
                                return _wrap_MathOperations_std_mtx_add__SWIG_0(
                                    self,
                                    argc,
                                    argv);
                            }
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    void *vptr = 0;
                    int res =
                        SWIG_ConvertPtr(argv[3], &vptr, SWIGTYPE_p_double, 0);
                    _v = SWIG_CheckState(res);
                    if (_v) {
                        {
                            int res = SWIG_AsVal_int(argv[4], NULL);
                        ...
                        if (_v) {
                            ...
                            if (_v) {
                                return _wrap_MathOperations_std_mtx_add__SWIG_1(
                                    self,
                                    argc,
                                    argv);
                            }
        ...
        if (_v) {
            ...
            if (_v) {
                ...
                if (_v) {
                    void *vptr = 0;
                    int res =
                        SWIG_ConvertPtr(argv[3], &vptr, SWIGTYPE_p_float, 0);
                    _v = SWIG_CheckState(res);
                    if (_v) {
                        {
                            int res = SWIG_AsVal_int(argv[4], NULL);
                        ...
                        if (_v) {
                            ...
                            if (_v) {
                                return _wrap_MathOperations_std_mtx_add__SWIG_2(
                                    self,
                                    argc,
                                    argv);
                            }
...
fail:
    SWIG_Python_RaiseOrModifyTypeError(
        ...
        "'MathOperations_std_mtx_add'.\n"
        "  Possible C/C++ prototypes are:\n"
        "    MathOperations::std_mtx_add(int *,int *,int *,int,int)\n"
        "    MathOperations::std_mtx_add(double *,double *,double *,int,int)\n"
        "    MathOperations::std_mtx_add(float *,float *,float *,int,int)\n");
    return 0;
}

SWIGINTERN PyObject *_wrap_new_MathOperations(PyObject *self, PyObject *args) {
    PyObject *resultobj = 0;
    MathOperations *result = 0;

    if (!SWIG_Python_UnpackTuple(args, "new_MathOperations", 0, 0, 0))
        SWIG_fail;
    result = (MathOperations *)new MathOperations();
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result),
                                   SWIGTYPE_p_MathOperations,
                                   SWIG_POINTER_NEW | 0);
    return resultobj;
fail:
    return NULL;
...
SWIGINTERN PyObject *_wrap_delete_MathOperations(PyObject *self,
                                                 PyObject *args) {
    PyObject *resultobj = 0;
    MathOperations *arg1 = (MathOperations *)0;
    void *argp1 = 0;
...
SWIGINTERN PyObject *MathOperations_swigregister(PyObject *SWIGUNUSEDPARM(self),
                                                 PyObject *args) {
    PyObject *obj;
    if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj))
        return NULL;
    SWIG_TypeNewClientData(SWIGTYPE_p_MathOperations, SWIG_NewClientData(obj));
    return SWIG_Py_Void();
}

SWIGINTERN PyObject *MathOperations_swiginit(PyObject *SWIGUNUSEDPARM(self),
                                             PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
    ...
    {"new_std_mtx_add", _wrap_new_std_mtx_add, METH_O, NULL},
    {"delete_std_mtx_add", _wrap_delete_std_mtx_add, METH_O, NULL},
    {"std_mtx_add_getitem", _wrap_std_mtx_add_getitem, METH_VARARGS, NULL},
    {"std_mtx_add_setitem", _wrap_std_mtx_add_setitem, METH_VARARGS, NULL},
    {"MathOperations_add", _wrap_MathOperations_add, METH_VARARGS, NULL},
    {"MathOperations_subtract",
     _wrap_MathOperations_subtract,
     METH_VARARGS,
     NULL},
    {"MathOperations_multiply",
     _wrap_MathOperations_multiply,
     METH_VARARGS,
     NULL},
    {"MathOperations_divide", _wrap_MathOperations_divide, METH_VARARGS, NULL},
    {"MathOperations_std_mtx_add",
     _wrap_MathOperations_std_mtx_add,
     METH_VARARGS,
     NULL},
    {"new_MathOperations", _wrap_new_MathOperations, METH_NOARGS, NULL},
    {"delete_MathOperations", _wrap_delete_MathOperations, METH_O, NULL},
    {"MathOperations_swigregister", MathOperations_swigregister, METH_O, NULL},
    {"MathOperations_swiginit", MathOperations_swiginit, METH_VARARGS, NULL},
    {NULL, NULL, 0, NULL}};

/* -------- TYPE CONVERSION AND EQUIVALENCE RULES (BEGIN) -------- */

static swig_type_info _swigt__p_MathOperations =
    {"_p_MathOperations", "MathOperations *", 0, 0, (void *)0, 0};
...
static swig_type_info _swigt__p_unsigned_int = {
    "_p_unsigned_int",
    "uint32_t *|uint_fast16_t *|uint_fast32_t *|uint_least32_t *|uintptr_t "
    "*|unsigned int *",
    0,
    0,
    (void *)0,
...
static swig_type_info _swigt__p_unsigned_long_long = {
    ...
    "uint64_t *|uint_fast64_t *|uint_least64_t *|uintmax_t *|unsigned long "
    "long *",
    0,
    0,
    (void *)0,
...
static swig_cast_info _swigc__p_MathOperations[] = {
    {&_swigt__p_MathOperations, 0, 0, 0},
    {0, 0, 0, 0}};
static swig_cast_info _swigc__p_char[] = {{&_swigt__p_char, 0, 0, 0},
                                          {0, 0, 0, 0}};
static swig_cast_info _swigc__p_double[] = {{&_swigt__p_double, 0, 0, 0},
                                            {0, 0, 0, 0}};
static swig_cast_info _swigc__p_float[] = {{&_swigt__p_float, 0, 0, 0},
                                           {0, 0, 0, 0}};
static swig_cast_info _swigc__p_int[] = {{&_swigt__p_int, 0, 0, 0},
                                         {0, 0, 0, 0}};
static swig_cast_info _swigc__p_long_long[] = {{&_swigt__p_long_long, 0, 0, 0},
                                               {0, 0, 0, 0}};
static swig_cast_info _swigc__p_short[] = {{&_swigt__p_short, 0, 0, 0},
                                           {0, 0, 0, 0}};
static swig_cast_info _swigc__p_signed_char[] = {
    {&_swigt__p_signed_char, 0, 0, 0},
    {0, 0, 0, 0}};
...
SWIGRUNTIME void SWIG_InitializeModule(SWIG_INIT_CLIENT_DATA_TYPE clientdata) {
    ...
    if (!module_head) {
        ...
        do {
            if (iter == &swig_module) {
                /* Our module is already in the list, so there's nothing more to
                 * do. */
                return;
            }
            iter = iter->next;
    ...
    for (i = 0; i < swig_module.size; ++i) {
        ...
        if (swig_module.next != &swig_module) {
            type =
                SWIG_MangledTypeQueryModule(swig_module.next,
                                            &swig_module,
                                            swig_module.type_initial[i]->name);
        }
        if (type) {
...
void
    ...
    static PyGetSetDef this_getset_def = {(char *)"this",
                                          &SwigPyBuiltin_ThisClosure,
                                          NULL,
                                          NULL,
                                          NULL};
    ...
    SWIG_Python_FixMethods(SwigMethods,
                           swig_const_table,
                           swig_types,
                           swig_type_initial);
    ...
    for (i = 0; swig_const_table[i].name != 0; ++i)
        SwigPyBuiltin_AddPublicSymbol(public_interface,
