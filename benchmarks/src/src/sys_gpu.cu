...
void System::gpu_info() {
    ...
    System::cuda_cores = _gpu_arch(deviceProp.major, deviceProp.minor);
...
void System::gpu_info_print() {
    ...
    std::cout << "  ( " << System::gpu_mp_count << ") Multiprocessors, ("
              ...
              << ") CUDA Cores/MP:     " << System::cuda_cores << " CUDA Cores"
              << std::endl;
    ...
    std::cout << "  Max dimension size of a thread block (x,y,z): ("
              << System::max_dim_threads[0] << ", "
              << System::max_dim_threads[1] << ", "
